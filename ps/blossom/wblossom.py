...
from blossom.graph import UGraph
...
class DressedGraph:
    ...
    def phase_start(self):  # initialize and reset some states for a new phase
        ...
        self.stfb = {
            i: None for i in self.graph.vertex
        }  # valid for top blossom, labeled as v, None stands no blossom in than v
